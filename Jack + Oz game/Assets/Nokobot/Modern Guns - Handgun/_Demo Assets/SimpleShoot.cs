...
public class SimpleShoot : MonoBehaviour
{
    ...
    public string Bulletnew() {
        Debug.Log(bulletsLeft + " / " + magazineSize);
        return (bulletsLeft.ToString() + " / " + magazineSize.ToString());
    }
    public string BulletStart(){
        Debug.Log(magazineSize + " / " + magazineSize);
        return (magazineSize.ToString() + " / " + magazineSize.ToString());
    }
